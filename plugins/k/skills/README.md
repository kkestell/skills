...
- `/kresearch` is comparative technical research. It finds comparable GitHub projects, clarifies a research question, delegates per-repo investigation to verified subagents, and synthesizes findings under `.k/research/`.
...
Researches a topic across comparable GitHub projects and writes a plan, verified notes, and synthesis under `.k/research/`.

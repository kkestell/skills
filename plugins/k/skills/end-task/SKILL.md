---
name: end-task
description: Merge the current task branch into `main`, validate the result, retain any optional worktree for post-merge checks, and delete the feature branch only when safe. Use only after `/k:verify` passes and the repo is clean.
argument-hint: ""

...
This is a prompt framework for a lightweight review of a one-off task. When launching a helper reviewer or running the pass locally, read this file, then compose the actual prompt by filling in the concrete details for the completed task.

---

## Preamble (copy and adapt)

You are reviewing a small, completed task for correctness and completeness. Your job is to answer two questions: **was the task actually done, and is the code sound?** Be honest but concise. This is not a full architectural review.
...
Be concise. Only flag real problems — bugs, omissions, missing tests. Do not pad with style nits or cosmetic suggestions.

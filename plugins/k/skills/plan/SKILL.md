---
name: plan
description: Turn clear requirements into a repo-specific markdown plan with tasks, related code, validation steps, and open questions. Use after `/k:brainstorm` or once scope is clear, before `/k:work`.
...
5. Decide whether more research is needed.
   - Use `/k:research` whenever the plan needs evidence beyond obvious local patterns.

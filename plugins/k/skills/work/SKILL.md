...
8. If a new repo, library, dependency, or web question blocks implementation, invoke `/k:research`, save the answer under `<docs_path>/research/`, and continue with the new note as input.
9. Commit each tested logical chunk using `/k:commit`.
...
13. Then offer `/k:verify` or `/k:end-task`.

...
10. Evaluate surviving candidates.
    ...
    - Score each surviving candidate against these criteria, roughly in priority order:
      ...
      - **Minimal surface area** — Does the solution introduce new configuration knobs, new abstractions, new failure modes? Prefer the option that adds the least new _stuff_ to the system's conceptual footprint.
